...
class BtnFinishTravel extends StatelessWidget {
  ...
  const BtnFinishTravel({super.key, required this.messageService});
  ...
  Widget build(BuildContext context) {
    ...
    double responsiveLeft = responsiveUtil.getResponsiveWidth(0.04); // Adjust the value to fit your design
    double responsiveRight = responsiveUtil.getResponsiveWidth(0.52);
